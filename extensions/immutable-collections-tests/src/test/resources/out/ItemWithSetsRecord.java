...
import pl.com.labaj.autorecord.extension.arice.Methods_KXFGNRHTT;
import pl.com.labaj.autorecord.testcase.user.UserCollections;

@Generated("pl.com.labaj.autorecord.AutoRecord")
@GeneratedWithAutoRecord
@AutoRecordImmutableCollectionsUtilities(
        className = "pl.com.labaj.autorecord.extension.arice.Methods_KXFGNRHTT",
        immutableTypes = {
...
record ItemWithSetsRecord<E, M extends Enum<M>>(Set<E> set,
    ...
    ItemWithSetsRecord {
        ...
        set = Methods_KXFGNRHTT.immutable(set);
        sortedSet = Methods_KXFGNRHTT.immutable(sortedSet);
        navigableSet = Methods_KXFGNRHTT.immutable(navigableSet);
        nullableSet = isNull(nullableSet) ? null : Methods_KXFGNRHTT.immutable(nullableSet);
        nullableSortedSet = isNull(nullableSortedSet) ? null : Methods_KXFGNRHTT.immutable(nullableSortedSet);
        nullableNavigableSet = isNull(nullableNavigableSet) ? null : Methods_KXFGNRHTT.immutable(nullableNavigableSet);
    }
}
...
class BasicTest {
    ...
    void shouldGenerateRecord() {
        //given
        var inputInterface = JavaFileObjects.forSourceString("pl.com.labaj.autorecord.test.Basic", """
        ...
        var expectedRecord = JavaFileObjects.forSourceString("pl.com.labaj.autorecord.test.BasicRecord", """
                package pl.com.labaj.autorecord.test;
        ...
        assertAll(
                ...
                () -> assertThat(compilation).generatedSourceFile("pl.com.labaj.autorecord.test.BasicRecord").hasSourceEquivalentTo(expectedRecord)
        );
    }
}

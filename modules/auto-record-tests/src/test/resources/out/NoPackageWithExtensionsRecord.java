...
record NoPackageWithExtensionsRecord(String property, @Nullable Memoizer<String> toStringMemoizer) implements NoPackageWithExtensions {
    NoPackageWithExtensionsRecord {
    ...
    NoPackageWithExtensionsRecord(String property) {
    ...
    private String _toString() {
        return "NoPackageWithExtensionsRecord[" +
                "property = " + property +
                "]";
    }
}
 ...
 *
 * <p>The value will be computed on the first call to {@link #computeAsFloatIfAbsent(FloatSupplier)} method and the same value will be returned for
 * subsequent calls
 ...
 */
@API(status = STABLE)
public final class FloatMemoizer {
     ...
     *
     * @param valueSupplier a {@link FloatSupplier} representing the function that will generate the value to be memoized

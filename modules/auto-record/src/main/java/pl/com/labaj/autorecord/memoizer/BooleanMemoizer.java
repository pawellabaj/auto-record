 ...
 *
 * <p>The value will be computed on the first call to {@link #computeAsBooleanIfAbsent(BooleanSupplier)} method and the same value will be returned for
 * subsequent calls
...
public final class BooleanMemoizer {
     ...
     *
     * @param valueSupplier a {@link java.util.function.BooleanSupplier} representing the function that will generate the value to be memoized

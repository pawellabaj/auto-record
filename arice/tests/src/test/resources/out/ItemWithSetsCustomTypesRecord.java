...
import pl.com.labaj.autorecord.extension.arice.ARICE_IVDASUG;
...
@ARICEUtilities(
        ...
        className = "pl.com.labaj.autorecord.extension.arice.ARICE_IVDASUG"
)
record ItemWithSetsCustomTypesRecord<E, M extends Enum<M>>(Set<E> set,
                                                           HashSet<E> hashSet,
                                                           ...
                                                           @Nullable ImmutableSet<E> nullableImmutableSet) implements ItemWithSetsCustomTypes<E, M> {
    ItemWithSetsCustomTypesRecord {
        ...
        set = ARICE_IVDASUG.immutable(set);
        sortedSet = ARICE_IVDASUG.immutable(sortedSet);
        navigableSet = ARICE_IVDASUG.immutable(navigableSet);
        nullableSet = isNull(nullableSet) ? null : ARICE_IVDASUG.immutable(nullableSet);
        nullableSortedSet = isNull(nullableSortedSet) ? null : ARICE_IVDASUG.immutable(nullableSortedSet);
        nullableNavigableSet = isNull(nullableNavigableSet) ? null : ARICE_IVDASUG.immutable(nullableNavigableSet);
    }
}
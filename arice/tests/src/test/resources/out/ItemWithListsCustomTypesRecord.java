...
@ARICEUtilities(
    ...
    record ItemWithListsCustomTypesRecord<E>(List<E> list, LinkedList<E> linkedList,
        ArrayList<E> arrayList, UserCollections.UserList<E> userList,
        UserCollections.UserListImpl<E> userListImpl, ImmutableList<E> immutableList,
        @Nullable List<E> nullableList, @Nullable LinkedList<E> nullableLinkedList,
                                         ...
                                         @Nullable ImmutableList<E> nullableImmutableList) implements ItemWithListsCustomTypes<E> {
    ItemWithListsCustomTypesRecord {
